...
import * as ModelActions from "./delegate.actions";
...
export class DelegateEffects {
	constructor(
		...
		private apiService: DelegateService,
	...
	loadAll$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DelegateActionTypes.appComponentInitialized,
				ModelActions.DelegateActionTypes.COLLECTION_LOAD_DELEGATES
			),
	...
	addData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DelegateActionTypes.MODEL_CreateInitiated
			),
			switchMap((action) =>
	...
	editData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DelegateActionTypes.MODEL_UpdateInitiated
			),
			switchMap((action) =>
	...
	editStatus$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DelegateActionTypes.MODEL_UpdateStatusInitiated
			),
			switchMap((action) =>
	...
	restoreData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DelegateActionTypes.MODEL_RestoreInitiated
			),
			switchMap((action) =>
	...
	deleteData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DelegateActionTypes.MODEL_DeleteInitiated
			),
			switchMap((action) =>
	...
	readonly showErrorAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.DelegateActionTypes.MODEL_RestoreFailed,
					ModelActions.DelegateActionTypes.MODEL_UpdateSuccess,
					ModelActions.DelegateActionTypes.MODEL_UpdateStatusFailed,
					ModelActions.DelegateActionTypes.MODEL_CreateFailed,
					//ModelActions.DelegateActionTypes.COLLECTION_LOADED_FAILED,
					ModelActions.DelegateActionTypes.MODEL_DeleteFailed
				),
				tap(
	...
	readonly showSuccessAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.DelegateActionTypes.MODEL_RestoreSuccess,
					ModelActions.DelegateActionTypes.MODEL_UpdateSuccess,
					ModelActions.DelegateActionTypes.MODEL_UpdateStatusSuccess,
					ModelActions.DelegateActionTypes.MODEL_CreateSuccess,
					ModelActions.DelegateActionTypes.COLLECTION_LOADED_SUCCESS,
					ModelActions.DelegateActionTypes.MODEL_DeleteSuccess
				),
				tap(
