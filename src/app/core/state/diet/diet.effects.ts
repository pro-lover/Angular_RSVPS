...
import { AlertService, DietService } from "@core/services";
import { Actions, createEffect, ofType } from "@ngrx/effects";
import { of } from "rxjs";
import { catchError, map, switchMap } from "rxjs/operators";
import * as ModelActions from "./diet.actions";
...
export class DietEffects {
	constructor(
		...
		private apiService: DietService,
	...
	loadAll$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DietActionTypes.appComponentInitialized,
				ModelActions.DietActionTypes.COLLECTION_LOAD_DIET
			),
	...
	addData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DietActionTypes.MODEL_CreateInitiated
			),
			switchMap((action) =>
	...
	editData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DietActionTypes.MODEL_UpdateInitiated
			),
			switchMap((action) =>
	...
	editStatus$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DietActionTypes.MODEL_UpdateStatusInitiated
			),
			switchMap((action) =>
	...
	restoreData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DietActionTypes.MODEL_RestoreInitiated
			),
			switchMap((action) =>
	...
	deleteData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.DietActionTypes.MODEL_DeleteInitiated
			),
			switchMap((action) =>
	...
	readonly showErrorAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.DietActionTypes.MODEL_RestoreFailed,
					ModelActions.DietActionTypes.MODEL_UpdateSuccess,
					ModelActions.DietActionTypes.MODEL_UpdateStatusFailed,
					ModelActions.DietActionTypes.MODEL_CreateFailed,
					//ModelActions.DietActionTypes.COLLECTION_LOADED_FAILED,
					ModelActions.DietActionTypes.MODEL_DeleteFailed
				),
				tap(
	...
	readonly showSuccessAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.DietActionTypes.MODEL_RestoreSuccess,
					ModelActions.DietActionTypes.MODEL_UpdateSuccess,
					ModelActions.DietActionTypes.MODEL_UpdateStatusSuccess,
					ModelActions.DietActionTypes.MODEL_CreateSuccess,
					ModelActions.DietActionTypes.COLLECTION_LOADED_SUCCESS,
					ModelActions.DietActionTypes.MODEL_DeleteSuccess
				),
				tap(
