...
import { AlertService, TravelService } from "@core/services";
import { Actions, createEffect, ofType } from "@ngrx/effects";
import { of } from "rxjs";
import { catchError, map, switchMap } from "rxjs/operators";
import * as ModelActions from "./travel.actions";
...
export class TravelEffects {
	constructor(
		...
		private apiService: TravelService,
	...
	loadAll$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.TravelActionTypes.appComponentInitialized,
				ModelActions.TravelActionTypes.COLLECTION_LOAD_TRAVEL
			),
	...
	addData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.TravelActionTypes.MODEL_CreateInitiated
			),
			switchMap((action) =>
	...
	editData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.TravelActionTypes.MODEL_UpdateInitiated
			),
			switchMap((action) =>
	...
	editStatus$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.TravelActionTypes.MODEL_UpdateStatusInitiated
			),
			switchMap((action) =>
	...
	restoreData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.TravelActionTypes.MODEL_RestoreInitiated
			),
			switchMap((action) =>
	...
	deleteData$ = createEffect(() =>
		this.actions$.pipe(
			ofType(
				ModelActions.TravelActionTypes.MODEL_DeleteInitiated
			),
			switchMap((action) =>
	...
	readonly showErrorAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.TravelActionTypes.MODEL_RestoreFailed,
					ModelActions.TravelActionTypes.MODEL_UpdateSuccess,
					ModelActions.TravelActionTypes.MODEL_UpdateStatusFailed,
					ModelActions.TravelActionTypes.MODEL_CreateFailed,
					//ModelActions.TravelActionTypes.COLLECTION_LOADED_FAILED,
					ModelActions.TravelActionTypes.MODEL_DeleteFailed
				),
				tap(
	...
	readonly showSuccessAlert$ = createEffect(
		() => {
			return this.actions$.pipe(
				ofType(
					ModelActions.TravelActionTypes.MODEL_RestoreSuccess,
					ModelActions.TravelActionTypes.MODEL_UpdateSuccess,
					ModelActions.TravelActionTypes.MODEL_UpdateStatusSuccess,
					ModelActions.TravelActionTypes.MODEL_CreateSuccess,
					ModelActions.TravelActionTypes.COLLECTION_LOADED_SUCCESS,
					ModelActions.TravelActionTypes.MODEL_DeleteSuccess
				),
				tap(
