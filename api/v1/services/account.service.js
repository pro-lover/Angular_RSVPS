...
async function requestProjectleader({ account, projects }, origin) {

	// send email
	await sendRequestProjectleader( account, projects, origin);
}
...
function basicDetails(account) {
	//return account;
    const { id, title, firstName, lastName, email, role, status, created, deletedAt, updated, isVerified, history, version, lastEditedBy } = account;
    return { id, title, firstName, lastName, email, role, status, created, deletedAt, updated, isVerified, history, version, lastEditedBy };
}
...
async function sendRequestProjectleader(account, projects, origin) {
	let message;
	if (origin) {
